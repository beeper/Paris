...
@property  id  assistant; // @synthesize assistant=_assistant;
...
- (void)showRunOutOfDevicesOptionsSheetForDevice:(id)arg1 withCompletion:(id)arg2;
- (void)showLoginAlertWithTitle:(id)arg1 message:(id)arg2 buttleTitle:(id)arg3 withCompletion:(id)arg4;
- (void)showLoginAlertWithTitle:(id)arg1 message:(id)arg2 withCompletion:(id)arg3;
