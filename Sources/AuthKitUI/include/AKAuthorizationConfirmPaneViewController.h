...
- (void)_paneDelegate_authorizationPaneViewControllerDidRequestAuthorizationWithUserProvidedInformation:(id)arg1 completion:(id)arg2;
...
- (void)_performAuthorizationWithRawPassword:(id)arg1 completionHandler:(id)arg2;
