...
@class AKAuthorization, AKAuthorizationPaneViewController, AKAuthorizationPresentationContext, AKAuthorizationUserResponse, NSDictionary, NSError, NSString, AKIconContext;
