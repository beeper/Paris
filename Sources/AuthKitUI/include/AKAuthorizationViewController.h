...
- (void)authorizationPaneViewController:(id)arg1 didRequestIconWithCompletion:(id)arg2;
- (void)authorizationPaneViewController:(id)arg1 didRequestAuthorizationWithUserProvidedInformation:(id)arg2 completion:(id)arg3;
