...
- (void)webView:(WebView *)arg1 willPerformDragDestinationAction:(unsigned long long)arg2 forDraggingInfo:( id )arg3;
- (unsigned long long)webView:(WebView *)arg1 dragDestinationActionMaskForDraggingInfo:( id )arg2;
- (BOOL)webView:(WebView *)arg1 shouldPerformAction:(SEL)arg2 fromSender:(id)arg3;
- (BOOL)webView:(WebView *)arg1 validateUserInterfaceItem:( id )arg2 defaultValidation:(BOOL)arg3;
...
- (void)webView:(WebView *)arg1 runOpenPanelForFileButtonWithResultListener:( id )arg2 allowMultipleFiles:(BOOL)arg3;
- (void)webView:(WebView *)arg1 runOpenPanelForFileButtonWithResultListener:( id )arg2;
