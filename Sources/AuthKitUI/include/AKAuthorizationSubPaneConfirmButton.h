...
- (void)_performPasscodeValidations:(id)arg1;
...
- (void)finishProcessingWithCompletionHandler:(id)arg1;
- (void)_enterProcessingStateWithCompletionHandler:(id)arg1;
- (id)callerIconBundlePath;
- (id)localizedCallerName;
- (void)processBiometricMatchWithCompletionHandler:(id)arg1;
