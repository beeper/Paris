...
@interface AKAppleIDAuthenticationInAssistantContext : AKAppleIDAuthenticationInAppContext <AKAppleIDAuthenticationUIProvider, NSTextFieldDelegate, AuthWebViewDelegate, MBUIDelegate, MBWebKitViewControllerDelegate, AKSecondFactorCodeEntryDelegate, AKiCDPValidationDelegate, AKiCDPRecoveryKeyDelegate, AKAppleIDAuthenticationInAppContextPasswordDelegate, NSSecureCoding>
{
    ...
    CDPRemoteDeviceSecretValidator *_deviceValidator;
     id  _recoveryKeyValidator;
    id _recoveryKeyValidationCompletionBlock;
    id _passwordHandler;
}

+ (BOOL)supportsSecureCoding;

@property(copy) id passwordHandler; // @synthesize passwordHandler=_passwordHandler;
...
@property(copy) id recoveryKeyValidationCompletionBlock; // @synthesize recoveryKeyValidationCompletionBlock=_recoveryKeyValidationCompletionBlock;
@property(retain)  id  recoveryKeyValidator; // @synthesize recoveryKeyValidator=_recoveryKeyValidator;
...
@property(copy, nonatomic) id forgotBlock; // @synthesize forgotBlock=_forgotBlock;
...
@property(copy, nonatomic) id alternateBlock; // @synthesize alternateBlock=_alternateBlock;
...
@property(copy, nonatomic) id nextBlock; // @synthesize nextBlock=_nextBlock;
...
@property(copy, nonatomic) id previousBlock; // @synthesize previousBlock=_previousBlock;
...
- (void)context:(id)arg1 needsPasswordWithCompletion:(id)arg2;
- (void)userCancelledRecoveryKeyEntry;
- (void)validateRecoveryKey:(id)arg1 completionHandler:(id)arg2;
...
- (void)validateDevice:(id)arg1 withSecret:(id)arg2 completionHandler:(id)arg3;
- (void)cdpContext:(id)arg1 promptForRecoveryKeyWithValidator:(id)arg2 completion:(id)arg3;
...
- (void)cdpContext:(id)arg1 promptForLocalSecretWithCompletion:(id)arg2;
...
- (void)setupNoUILoginNavigationWithCompletionBlock:(id)arg1;
- (void)setupLoginNavigationWithCompletionBlock:(id)arg1;
