...
@interface AKAppleIDAuthenticationiCloudPrefPaneViewController : NSViewController <AKAppleIDAuthenticationInAppContextPasswordDelegate>
{
    ...
    id _loginButtonAction;
    id _forgotButtonAction;
    id _createButtonAction;
...
@property(copy) id createButtonAction; // @synthesize createButtonAction=_createButtonAction;
@property(copy) id forgotButtonAction; // @synthesize forgotButtonAction=_forgotButtonAction;
@property(copy) id loginButtonAction; // @synthesize loginButtonAction=_loginButtonAction;
