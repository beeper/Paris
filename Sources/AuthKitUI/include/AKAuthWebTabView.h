...
@interface AKAuthWebTabView : NSObject <AKICAUIDelegate, AKICAWebKitViewControllerDelegate, AuthWebViewDelegate, AKWebViewButtonBarDelegate, AKMBICAUIDelegate, AKInAssistantNavigationHandler>
{
    ...
    BOOL _contentLoaded;
     id  _delegate;
     id  _mbUIDelegate;
     id  _mbWebKitViewControllerDelegate;
...
@property(copy) id defaultAction; // @synthesize defaultAction=_defaultAction;
...
@property(nonatomic) __weak  id  mbWebKitViewControllerDelegate; // @synthesize mbWebKitViewControllerDelegate=_mbWebKitViewControllerDelegate;
@property(nonatomic) __weak  id  mbUIDelegate; // @synthesize mbUIDelegate=_mbUIDelegate;
...
- (void)getAuthKitDataWithResponse:(id)arg1 error:(id)arg2 completion:(id)arg3;
