...
- (void)displayAlertForContext:(id)arg1 error:(id)arg2 completion:(id)arg3;
- (void)context:(id)arg1 needsPasswordWithCompletion:(id)arg2;
- (void)authenticationController:(id)arg1 shouldContinueWithAuthenticationResults:(id)arg2 error:(id)arg3 forContext:(id)arg4 completion:(id)arg5;
