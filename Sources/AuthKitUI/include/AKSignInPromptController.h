...
@interface AKSignInPromptController : NSViewController <NSTouchBarProvider>
{
    ...
    id _otherButtonAction;
    id _alternativeButtonAction;
...
@property(copy) id alternativeButtonAction; // @synthesize alternativeButtonAction=_alternativeButtonAction;
@property(copy) id otherButtonAction; // @synthesize otherButtonAction=_otherButtonAction;
