...
@class AKAccountRecoveryContext, AKApplicationMetadataInfo, AKAppleIDServerResourceLoadDelegate, AKCircleRequestPayload, AKAppleIDAuthenticationContext, AKCircleRequestContext, AKDeviceListRequestContext, AKFollowUpTearDownContext, AKUserInformation, NSArray, NSDictionary, NSHTTPURLResponse, NSNumber, NSString, NSError;
...
- (void)setConfigurationInfo:( id )arg1 forIdentifier:(NSString *)arg2 forAltDSID:(NSString *)arg3 completion:(void (^)(BOOL, NSError *))arg4;
