...
//enum AKAppleIDAuthenticationServiceType: Int64 {
//    case iCloud = 0x1
//    case iTunes = 0x2
//    case iMessage = 0x4
//    case FaceTime = 0x5
...
typedef enum AKAppleIDAuthenticationServiceType : long long {
    kAppleIDAuthenticationServiceTypeICloud = 0x1,
    kAppleIDAuthenticationServiceTypeITunes = 0x2,
    kAppleIDAuthenticationServiceTypeIMessage = 0x4,
    kAppleIDAuthenticationServiceTypeFaceTime = 0x5,
    kAppleIDAuthenticationServiceTypeGameCenter = 0x6,
    kAppleIDAuthenticationServiceTypeICloud2 = 0x7
} AKAppleIDAuthenticationServiceType;

typedef void (^AKAppleIDBasicLoginCompletion)(NSString *username, NSString *password, NSDictionary *additionalData, NSError *error);
typedef void (^AKAppleIDSecondFactorCompletion)(NSNumber *secondFactorCode, NSError *error);
typedef void (^AKAppleIDGenericDismissUICompletion)(BOOL didSucceed, NSError *error);
...
@interface AKAppleIDAuthenticationContext : NSObject <AKAppleIDAuthenticationLimitedUIProvider, AKAuthenticationContext, NSSecureCoding>
{
    ...
    NSString *_username;
    AKAppleIDAuthenticationServiceType _serviceType;
    NSString *_reason;
...
@property(retain)  id  anisetteDataProvider; // @synthesize anisetteDataProvider=_anisetteDataProvider;
...
@property AKAppleIDAuthenticationServiceType serviceType; // @synthesize serviceType=_serviceType;
...
- (void)presentSecondFactorAlertWithError:(NSError*)error title:(NSString*)title message:(NSString*)message completion:(AKAppleIDSecondFactorCompletion)completion;
- (void)dismissSecondFactorUIWithCompletion:(AKAppleIDGenericDismissUICompletion)arg1;
- (void)presentSecondFactorUIWithCompletion:(AKAppleIDSecondFactorCompletion)arg1;
- (void)presentLoginAlertWithError:(NSError*)arg1 title:(NSString*)arg2 message:(NSString*)arg3 completion:(AKAppleIDBasicLoginCompletion)arg4;
- (void)dismissBasicLoginUIWithCompletion:(AKAppleIDGenericDismissUICompletion)arg1;
@property(readonly) BOOL _requiresPasswordInput;
- (void)presentBasicLoginUIWithCompletion:(AKAppleIDBasicLoginCompletion)arg1;
...
-(void)set_performUIOutOfProcess:(BOOL)arg0;

-(long long) authenticationPromptStyle;
-(void) setAuthenticationPromptStyle:(long long)arg0;

-(BOOL)keepAlive;
-(void)set_keepAlive:(BOOL)arg0;
