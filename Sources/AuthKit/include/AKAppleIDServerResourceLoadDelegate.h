...
typedef enum AKAppleIDServerResourceAction : unsigned long long {
    AKAppleIDServerResourceActionCDPContinue = 0x1,
    AKAppleIDServerResourceActionCDPCancel = 0x2,
    AKAppleIDServerResourceActionCDPComplete = 0x3,
    AKAppleIDServerResourceActionCDPStartICSC = 0x4,
    AKAppleIDServerResourceActionContinue = 0x5,
    AKAppleIDServerResourceActionUnknown = 0x6
} AKAppleIDServerResourceAction;
...
+ (AKAppleIDServerResourceAction)signalFromServerResponse:(NSHTTPURLResponse*)arg1;
...
@property(retain, nonatomic)  id  anisetteDataProvider; // @synthesize anisetteDataProvider=_anisetteDataProvider;
...
- (BOOL)isResponseFinalForHSA2ServerFlow:(NSHTTPURLResponse*)arg1;
- (BOOL)isResponseActionable:(NSHTTPURLResponse*)arg1;
- (BOOL)isAuthenticationRequired:(id)arg1;
- (BOOL)isResponseFinal:(NSHTTPURLResponse*)arg1;
- (void)_signWithFeatureOptInHeaders:(NSMutableURLRequest*)arg1;
- (void)_signWithProxiedDeviceHeaders:(NSMutableURLRequest*)arg1;
- (void)signRequestWithCommonHeaders:(NSMutableURLRequest*)arg1;
- (void)_signRequest:(NSMutableURLRequest*)arg1;
- (id)signingController;
- (id)_proxiedProvisioningController;
- (void)signRequest:(NSMutableURLRequest*)arg1 withCompletionHandler:(void (^)(BOOL, NSError*))arg2;
