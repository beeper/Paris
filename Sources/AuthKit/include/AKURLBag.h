...
+ (id)_currentBags;
+ (instancetype)sharedBag;
+ (instancetype)bagForAltDSID:(NSString*)arg1;

@property(retain, nonatomic)  id  bagProvider; // @synthesize bagProvider=_bagProvider;
@property(copy, nonatomic) NSString *altDSID; // @synthesize altDSID=_altDSID;
- (void)forceUpdateBagWithUrlSwitchData:(id)arg1 completion:(id)arg2;
- (void)_fetchURLBagWithCompletion:(id)arg1;
...
- (void)requestNewURLBagIfNecessaryWithCompletion:(id)arg1;
