...
- (void)signaturesForData:(id)arg1 options:(id)arg2 completion:(id)arg3;
- (void)absintheSignatureForData:(id)arg1 completion:(id)arg2;
...
- (id)init;
- (void)_additionalAttestationHeadersForRequest:(id)arg1 withInterval:(id)arg2 completion:(id)arg3;
- (void)_additionalAbsintheHeadersForRequest:(id)arg1 completion:(id)arg2;
- (void)signingHeadersForRequest:(id)arg1 completion:(id)arg2;
