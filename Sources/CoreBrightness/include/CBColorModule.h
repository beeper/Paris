...
- (BOOL)isDFR;
- (void)reportToAggd:(id)arg1;
- (void)commitPowerLogReport:(id)arg1;
...
- (void)inputAmbientColorSample:(id)arg1 force:(BOOL)arg2 trust:(BOOL)arg3;
...
- (void)colorRampRoutine:(const id )arg1;
...
- (float)absoluteDifferenceForCurrentColor:(id)arg1 andDeltaError:(id)arg2;
