...
- (void)registerKeyboardNotificationCallbackBlock:(void (^)(id))arg1;
...
- (void)registerNotificationBlock:(void (^)(id))arg1 forProperties:(id)arg2;
- (void)unregisterPropertyNotificationBlock;
- (void)registerNotificationBlock:(void (^)(id))arg1;
- (void)unregisterDisplayNotificationBlock;
- (void)registerDisplayNotificationCallbackBlock:(void (^)(id))arg1;
