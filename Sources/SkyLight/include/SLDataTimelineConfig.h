...
+ (id)configWithName:(id)arg1 andUpdateBlock:(id)arg2;
...
@property(readonly, nonatomic) id updateBlock; // @synthesize updateBlock=_updateBlock;
@property(readonly, nonatomic) NSString *name; // @synthesize name=_name;
- (void)establishConnectionWithResultBlock:(id)arg1;
- (id)createXPCObject;
- (id)createNoSenderRecvPairWithQueue:(id)arg1 errorHandler:(id)arg2 eventHandler:(id)arg3;
- (id)createCancellableMachRecvSourceWithQueue:(id)arg1 cancelAction:(id)arg2 error:(id *)arg3;
...
- (void)dealloc;
- (id)initWithName:(id)arg1 andUpdateBlock:(id)arg2;
