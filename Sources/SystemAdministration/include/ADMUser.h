...
+ (instancetype _Nonnull)newUser NS_SWIFT_NAME(newUser());
+ (NSInteger)nextFreeUserID;
+ (NSArray<ADMUser*>*)allLocalUserNamesWithPrimaryGroup:(id)arg1;
+ (NSArray<ADMUser*>*)allLocalUsers;
+ (instancetype)findUserByID:(unsigned long long)arg1 searchParent:(BOOL)arg2;
+ (instancetype)findUserByFullName:(NSString*)arg1 searchParent:(BOOL)arg2;
+ (instancetype)findUserByName:(NSString*)arg1 searchParent:(BOOL)arg2;
+ (id)extendNameUntilUnique:(id)arg1;
+ (BOOL)isUserNameUnique:(id)arg1 searchParent:(BOOL)arg2;
+ (NSMutableDictionary*)defaultFamilySettings;
+ (unsigned long long)sizeOfUserHomeTemplate;
+ (NSString*)SBSNodeName;
...
+ (id)_createDSListFromArray:(id)arg1;
...
+ (NSArray<NSString*>*)_attributesToFetch;
...
- (BOOL)commitChanges;
- (BOOL)deleteUserWithParameters:(id)arg1 NS_SWIFT_NAME( deleteUser(withParameters:) );
- (BOOL)deleteUser NS_SWIFT_NAME( deleteUser() );
- (void)revertChanges;
